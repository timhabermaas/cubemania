...
ActiveRecord::Schema.define(:version => 20090305103953) do
  ...
  create_table "competitions", :force => true do |t|
    ...
    t.integer  "puzzle_id",      :limit => 11, :default => 0,      :null => false
    t.string   "repeat",         :limit => 32, :default => "once", :null => false
    t.boolean  "sticky"
    t.integer  "averages_count", :limit => 11, :default => 0,      :null => false
  ...
  create_table "puzzles", :force => true do |t|
    t.string   "name",               :limit => 64,                        :null => false
    t.integer  "kind_id",            :limit => 11,                        :null => false
    t.integer  "scramble_length",    :limit => 11
    t.integer  "record_id",          :limit => 11
    t.integer  "attempt_count",      :limit => 11, :default => 1,         :null => false
    t.integer  "countdown",          :limit => 11, :default => 15,        :null => false
  ...
  create_table "scrambles", :force => true do |t|
    ...
    t.integer  "competition_id", :limit => 11,   :null => false
    t.datetime "created_at"
  end
