...
Item.create!(:name => 'Timer', :description => 'Timer', :url => '/puzzles/4/times', :position => 1)
Item.create!(:name => 'Competitions', :description => 'Competitions', :url => '/puzzles/4/competitions', :position => 2)
Item.create!(:name => 'Users', :description => 'Users', :url => '/users', :position => 3)
Item.create!(:name => 'Records', :description => 'Records', :url => '/puzzles/4/times', :position => 4)
